...
import { createFsSoknadFromHendelser, sorterEtterDatoStigende } from './hentSoknadUtils';
    ...
    expect(createFsSoknadFromHendelser(data.hendelser, fiksDigisosSokerJson, 'VxBlk01Kz0a')).toEqual(
        {
            ...
            utbetalingerUtenSaksreferanse: [utbetalingUtenSak1Endret, utbetalingUtenSak2],
            saker: [{
                ...sak1,
...
test('funksjon sorterer dato med nyeste hendelser til slutt', () => {
    ...
    expect(sorterEtterDatoStigende(hendelser, (hendelser) =>hendelser.hendelsestidspunkt)).toEqual(
        [
